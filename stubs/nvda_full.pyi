...
class wx:
	...
	EVT_BUTTON: Any
	@staticmethod
	def CallAfter(func: Callable, *args: Any, **kwargs: Any) -> None: ...
...
class MessageDialog:
	@staticmethod
	def confirm(message: str, caption: Optional[str] = None) -> "ReturnCode": ...
	@staticmethod
	def ask(message: str, caption: Optional[str] = None) -> "ReturnCode": ...
