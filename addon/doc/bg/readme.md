# Дизайнер на съдържанието на клипборда (Clip Contents Designer) #
*	Автори: Noelia, Abdel.

Тази добавка служи за добавяне на текст към клипборда, което може да бъде полезно когато искате да обедините в едно отделни части от текст, готов за поставяне.
Съдържанието на клипборда може и да се изчиства или показва в режим на разглеждане.
...
* Показвай диалоговия прозорец с настройките при обновяване: Махнете отметката от това, ако не искате да виждате диалоговия прозорец за настройване на емулиране на копиране и изрязване при обновяване на добавката.
...
## Промени във версия 49.0.0
* Добавено е поле за отметка, за указване дали да се показва диалоговия прозорец с настройките, когато добавката се обновява.


## Промени във версия 46.0.0
* NVDA ще почиства HTML кода в съобщенията в режим на разглеждане.
* Добавен е бутон за затваряне на съобщенията в режим на разглеждане, в допълнение към клавиша Escape.


## Промени във версия 40.0.0
* Добавена е поддръжка за клавиатура на иврит.
